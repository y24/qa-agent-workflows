...
- Index coverage: every `wiki/documents/`, `wiki/viewpoints/`, and `wiki/glossary/` page appears in the right table in `index.md`.
- Filesystem consistency: every page listed in `index.md` exists.
- Page placement: document pages summarize one source, viewpoint pages capture reusable angles, and glossary pages define terms.
- Traceability: each viewpoint page lists the source documents it was generalized from.
