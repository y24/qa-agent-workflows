...
def print_usage(show_header: bool = True) -> None:
    ...
    console.print("  qatool workflow install --workflow scenario-test-design --agent copilot --yes")
    console.print("  qatool workflow install --workflow scenario-test-design --agent codex --yes")
